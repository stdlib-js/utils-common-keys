...
```javascript
commonKeys = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/utils-common-keys@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/utils-common-keys@umd/bundle.js"></script>
```
